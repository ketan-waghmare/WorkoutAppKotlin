...
import com.game.workoutappkotlin.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
        ...
        binding?.btnCalculateUnits?.setOnClickListener{
            if(validateMetricUnits()) {
                ...
                Toast.makeText(this@BMIActivity,
                    "Plese Enter valid values",
                        Toast.LENGTH_SHORT)
                    .show()
            }
        }

        binding?.btnCalculateUnits  
    }
    ...
    private fun displayBMIResult(bmi : Float) {
        ...
        if(bmi.compareTo(15f) <= 0) {
            ...
            bmiDescription = "Oops! You really need to take better care of yourself! Eat much"
    ...
    private fun calculatdeUnits() {
        ...
        if(currentVisibleView == METRIC_UNITS_VIEW) {
            ...
            if(validateUsUnits()) {
                ...
                val heightValue = usUnitHeightValueFeet.toFloat() +
                        usUnitHeightValueInch.toFloat() * 12
